...
?>
    ...
    <div class="paragraph1">
      <h1>OUR TEAM</h1>
      <h3><p>MyFoodStop was founded in 2017. We care about quality, craft and disciplined experimentation</p><p> We help innovate, develop and pioneer. </p></h3>
    </div>
    ...
    <h3>
      ...
      <p>
        <font color="green"><strong>MyFoodStop</strong></font>, as described above, can lead to <font color="green"><strong>error free, secure, reliable and fast management system.</strong></font> It can assist the user to concentrate on their other activities rather to concentrate on the record keeping. Thus it will help organization in better utilization of resources. The organization can maintain computerized records without redundant entries. That means that one need not be distracted by information that is not relevant, while being able to reach the information. 
      </p>
      <p>
